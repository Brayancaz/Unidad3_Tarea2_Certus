    ...
    <div className="grid grid-cols-3 gap-4">
      {gifs.map((gif, id) => (
        <div key={id} className="bg-white p-4 rounded shadow-md">
          <img src={gif.image} alt={gif.name} className="w-full h-auto" />
          <div>{gif.name}</div>
        ...
        <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-4 rounded shadow-md">
            ...
            <div>
              ...
              <p>Locación: {selectedCharacter.location.name}</p>
              ...
              {/* Agrega más detalles según la estructura de tu objeto de personaje */}
            </div>
            <button
